...
class GMLP(nn.Module):
    def __init__(
        self, num_features, num_hidden, num_classes, dropout=0.5, name="GraphMLP"
    ):
        super(GMLP, self).__init__()
        self.name = name
        self.num_hidden = num_hidden
        self.mlp = MLP(num_features, self.num_hidden, dropout)
        self.classifier = Linear(self.num_hidden, num_classes)
