...
def graph_connectivity(device, perm, edge_index, edge_weight, score, ratio, batch, N):
    ...
    index_E, value_E = add_remaining_self_loops(
        edge_index=index_E, edge_attr=value_E, fill_value=fill_value, num_nodes=kN
    )
